...
/* Fonction qui calcule les coordonnées min et max de x et y */
void chaineCoordMinMax(Chaines* C, double* xmin, double* ymin, double* xmax, double* ymax); 

/* Creation d'un Arbre Quaternaire */
ArbreQuat* creerArbreQuat(double xc, double yc, double coteX, double coteY);

/* Insertion d'un Noeud n dans un Arbre Quaternaire */ 
void insererNoeudArbre(Noeud* n, ArbreQuat** a, ArbreQuat* parent);

/* Recherche d'un Noeud dans l'Arbre Quaternaire, creation de celui-ci si pas present  */
Noeud* rechercheCreeNoeudArbre(Reseau* R, ArbreQuat** a, ArbreQuat* parent, double x, double y);

/* Reconstituation du Reseau a partir de la structure Chaines */
Reseau* reconstitueReseauArbre(Chaines* C);

/* Fonction qui libere la mémoire de l'Arbre Quaternaire */
